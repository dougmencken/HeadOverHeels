...
if [ ! -f src/Makefile ]
then
        LDFLAGS="-L/opt/xerces-c-3.2.1/lib -L/opt/ogg-vorbis/lib -L/opt/libpng-1.6.34/lib -L/opt/zlib-1.2.8/lib -L${pathToCompiler}/lib" \
        CPPFLAGS="-I/opt/libpng-1.6.34/include -I/opt/xerces-c-3.2.1/include -I/opt/allegro-4.4.2/include" \
