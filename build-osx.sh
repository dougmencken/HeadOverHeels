...
then
        LDFLAGS="-headerpad_max_install_names -L${a4path}/lib -L${a5path}/lib -L/opt/tinyxml2-6.2.0/lib -L/opt/ogg-vorbis/lib -L/opt/libpng-1.6.35/lib -L/opt/zlib-1.3.1/lib -L${pathToCompiler}/lib" \
        CPPFLAGS="-I/opt/zlib-1.3.1/include -I/opt/libpng-1.6.35/include -I/opt/tinyxml2-6.2.0/include -I/opt/ogg-vorbis/include -I${a4path}/include -I${a5path}/include" \
