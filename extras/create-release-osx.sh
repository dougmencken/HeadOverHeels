...
cp /opt/tinyxml2-11.0.0/lib/libtinyxml2.11.0.0.dylib "${headoverheelslibs}"/
cp /opt/libpng-1.6.50/lib/libpng16.16.dylib "${headoverheelslibs}"/
...
install_name_tool -change /opt/libpng-1.6.50/lib/libpng16.16.dylib "@executable_path/../Libraries/libpng16.16.dylib" "${headoverheelsbin}"
...
install_name_tool -change /opt/tinyxml2-11.0.0/lib/libtinyxml2.6.dylib "@executable_path/../Libraries/libtinyxml2.11.0.0.dylib" "${headoverheelsbin}"
